...
import { soundManager, SoundType } from "./SoundManager.js";
...
export class GameEngine {
  ...
  checkDotCollision() {
    ...
    if (result) {
      ...
      if (result.type === "powerDot") {
        soundManager.play(SoundType.EAT_POWER_DOT);
        this.activatePowerMode();
      } else {
        soundManager.play(SoundType.EAT_DOT);
      }
    }
  }
  ...
  checkGhostCollision() {
    ...
    if (this.isPowerMode) {
      // 吃掉幽灵
      soundManager.play(SoundType.EAT_GHOST);
